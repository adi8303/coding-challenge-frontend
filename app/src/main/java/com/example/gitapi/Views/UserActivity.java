...
import com.example.gitapi.Views.ApiRequest.ApiClient;
import com.example.gitapi.Views.ApiRequest.GitHubUserEndPoint;
...
public class UserActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            loadData();
//            ownedrepos.setVisibility(View.VISIBLE);
        ...
        public void loadData() {
            ...
            call.enqueue(new Callback<GitHubUsers>() {
                ...
                @Override
                public void onResponse(Call<GitHubUsers> call, Response<GitHubUsers>
                        response) {
